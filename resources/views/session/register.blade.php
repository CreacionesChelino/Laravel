                            ...
                            <form role="form text-left" method="POST" action="/register">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Nombre" name="name"
                                        id="name" aria-label="Nombre" aria-describedby="name"
                                        value="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Apellido Paterno" name="app"
                                        id="app" aria-label="Apellido Paterno" aria-describedby="Valdez etc."
                                        value="{{ old('app') }}">
                                    @error('app')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Apellido Materno" name="apm"
                                        id="apm" aria-label="Apellido Materno" aria-describedby="Valdez etc."
                                        value="{{ old('apm') }}">
                                    @error('apm')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <input type="email" class="form-control" placeholder="Correo Electronico"
                                        name="email" id="email" aria-label="Correo Electronico"
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Contraseña" name="password"
                                        id="password" aria-label="Contraseña" aria-describedby="password-addon">
                                    @error('password')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Numero Telefonico"
                                        name="phone" id="phone" aria-label="Numero Telefonico"
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Domcilio" name="address"
                                        id="address" aria-label="Domicilio" aria-describedby="Domicilio">
                                    @error('fn')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" value="3" placeholder="" name="role_id"
                                        id="role_id" aria-label="Domicilio" hidden>
                                    @error('fn')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-check form-check-info text-left">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Acepto <a href="javascript:;" class="text-dark font-weight-bolder">Terminos
                                            y
                                            Condiciones</a>
                                    </label>
                                    @error('agreement')
                                        <p class="text-danger text-xs mt-2">Primero, debes aceptar Terminos y Condiciones,
                                            despues
                                            inetente nuevamente
                                            registrarse.</p>
                                    @enderror
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-dark w-100 my-4 mb-2">Registrate</button>
                                </div>
                                <p class="text-sm mt-3 mb-0">¿Ya tienes cuenta? <a href="login"
                                        class="text-dark font-weight-bolder">Inicia Sesion</a></p>
                            </form>
                        </div>
                    </div>
                </div>
