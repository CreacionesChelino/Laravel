      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-8 mb-4 mx-auto text-center">
                  {{-- <a href="https://www.creative-tim.com/?_ga=2.242299972.757293697.1638911086-1528502635.1638911086"
                      target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
                      Company
                  </a>
              ...
              @if (!auth()->user() || \Request::is('static-sign-up'))
                  <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
                      ...
                      <a href="https://github.com/Du-F23" target="_blank" class="text-secondary me-xl-4 me-4">
              ...
              <div class="row">
                  <div class="col-8 mx-auto text-center mt-1">
                      <p class="mb-0 text-secondary">
                          ...
                          &
                          <a style="color: #252f40;" href="https://github.com/Du-F23" class="font-weight-bold ml-1"
                              target="_blank">Du-F23</a>.
                      </p>
                  </div>
              </div>
          @endif
