{{-- <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    id="sidenav-main"> --}}
@php use App\Models\Cart;use App\Models\Sales; @endphp
<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient"
    id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
           aria-hidden="true" id="iconSidenav"></i>
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Creaciones Chelino</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0 mb-2">
    <div class="w-auto max-height-vh-100 sidenav-header" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @else
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('carrito') ? 'active' : '' }}" href="{{ url('carrito') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-lg fa-shopping-cart ps-2 pe-2 text-center text-dark {{ Request::is('carrito') ? 'text-white' : 'text-dark' }} "
                               aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">Carrito</span>
                        @if(Cart::where('paid' , 0)->count() == 0)

                        @else
                        <span class="position-absolute start-80 translate-middle badge rounded-pill bg-danger">
                            + {{Cart::where('paid' , 0)->count()}}
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('compras') ? 'active' : '' }}" href="{{ url('compras') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-lg fa-shopping-cart ps-2 pe-2 text-center text-dark {{ Request::is('compras') ? 'text-white' : 'text-dark' }} "
                               aria-hidden="true"></i>
                        </div>
